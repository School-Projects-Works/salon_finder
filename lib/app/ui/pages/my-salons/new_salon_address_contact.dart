...
class NewSalonAddressContact extends ConsumerStatefulWidget {
  const NewSalonAddressContact({super.key, required this.formKey});
  final GlobalKey<FormState> formKey;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _NewSalonAddressContactState();
}

class _NewSalonAddressContactState
    extends ConsumerState<NewSalonAddressContact> {
          ...
          CustomTextFields(
            ...
            onSaved: (street) {
              if (street != null && street.trim().isNotEmpty) {
                ref.read(newSalonProvider.notifier).setStreet(street: street);
              }
            },
          ),
          const SizedBox(height: 22),
          CustomTextFields(
            ...
            onSaved: (city) {
              if (city != null && city.trim().isNotEmpty) {
                ref.read(newSalonProvider.notifier).setCity(city: city);
              }
            },
          ),
          const SizedBox(height: 22),
          CustomTextFields(
            ...
            onSaved: (region) {
              if (region != null && region.trim().isNotEmpty) {
                ref.read(newSalonProvider.notifier).setRegion(region: region);
              }
            },
          ),
          const SizedBox(height: 22),
          CustomTextFields(
            ...
            onSaved: (country) {
              if (country != null && country.trim().isNotEmpty) {
                ref
                    .read(newSalonProvider.notifier)
                ...
                child: CustomTextFields(
                  ...
                  onSaved: (lat) {
                    if (lat != null && lat.trim().isNotEmpty) {
                      ref.read(newSalonProvider.notifier).setLat(lat: lat);
                    }
                  },
                ),
              ),
                ...
                child: CustomTextFields(
                  ...
                  onSaved: (lng) {
                    if (lng != null && lng.trim().isNotEmpty) {
                      ref.read(newSalonProvider.notifier).setLng(lng: lng);
                    }
                  },
                ),
              ),
          ...
          CustomTextFields(
            ...
            onSaved: (email) {
              if (email != null && email.trim().isNotEmpty) {
                ref.read(newSalonProvider.notifier).setEmail(email: email);
              }
            },
          ),
          const SizedBox(height: 22),
          CustomTextFields(
            ...
            onSaved: (phone) {
              if (phone != null && phone.trim().isNotEmpty) {
                ref.read(newSalonProvider.notifier).setPhone(phone: phone);
              }
            },
          ),
        ],

...
class NewSalonServices extends ConsumerStatefulWidget {
  const NewSalonServices({super.key});
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _NewSalonServicesState();
}

class _NewSalonServicesState extends ConsumerState<NewSalonServices> {
  @override
          ...
          return Card(
            child: ListTile(
              ...
              trailing: IconButton(
                ...
                onPressed: () =>
                    ref.read(newSalonProvider.notifier).removeServiceAt(idx),
              ),
            ),
          );
        }),
        ...
        actions: [
          ...
          CustomButton(
            ...
            onPressed: () {
              ...
              ref.read(newSalonProvider.notifier).addOrUpdateService(svc);
              Navigator.pop(dctx);
            },
            text: 'Add',
            radius: 2,

...
class NewSalonWorkingHours extends ConsumerStatefulWidget {
  const NewSalonWorkingHours({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _NewSalonWorkingHoursState();
}

class _NewSalonWorkingHoursState extends ConsumerState<NewSalonWorkingHours> {
